...
int main(int argc, char **argv) {
    ...
    // The rotation vector uses AngleAxis, the underlying layer is not directly a Matrix,
    ...
    Isometry3d T = Isometry3d::Identity(); // Although called 3d, it is essentially a 4x4 matrix
